...
def on_new_client(socket, addr):
    ...
    if info['msg'].__contains__('e'): # caso msg seja esquerda
       direction = 1
       
    elif info['msg'].__contains__('d'): # caso msg seja direita
        direction = -1
    
    elif info['msg'].__contains__('c'): # caso msg seja cima
        if speed < 10:
            speed = speed + 1
    
    elif info['msg'].__contains__('b'): # caso msg seja baixo
        if speed > 0:
            speed = speed - 1
    else:
        speed = 0
